...
object JourneyConfigDefaults {
  ...
  case class EnglishConstants(isUkMode: Boolean) extends JourneyConfigDefaults {
    ...
    def defaultPhaseBannerHtml(link: String) = s"This is a new service – your <a href='$link' class='govuk-link'>feedback</a> will help us to improve it."
  }
  ...
  case class WelshConstants(isUkMode: Boolean) extends JourneyConfigDefaults {
    ...
    def defaultPhaseBannerHtml(link: String) = s"Mae hwn yn wasanaeth newydd – bydd eich <a href='$link' class='govuk-link'>adborth</a> yn ein helpu i’w wella."
  }
