...
case class Timeout(timeoutAmount: Int, timeoutUrl: String, timeoutKeepAliveUrl: String)
...
case class ResolvedJourneyConfig(cfg: JourneyConfig, journeyConfigDefaults: JourneyConfigDefaults) {
  val continueUrl: String = cfg.continueUrl
  val lookupPage: ResolvedLookupPage = ResolvedLookupPage(cfg.lookupPage.getOrElse(LookupPage()), journeyConfigDefaults)
  val selectPage: ResolvedSelectPage = ResolvedSelectPage(cfg.selectPage.getOrElse(SelectPage()), journeyConfigDefaults)
  val confirmPage: ResolvedConfirmPage = ResolvedConfirmPage(cfg.confirmPage.getOrElse(ConfirmPage()), journeyConfigDefaults)
  val editPage: ResolvedEditPage = ResolvedEditPage(cfg.editPage.getOrElse(EditPage()), journeyConfigDefaults)
  ...
  val phaseBannerHtml: String = cfg.phaseBannerHtml.getOrElse(journeyConfigDefaults.defaultPhaseBannerHtml(phaseFeedbackLink))
...
case class ResolvedConfirmPage(p: ConfirmPage, journeyConfigDefaults: JourneyConfigDefaults) {
  val title: String = p.title.getOrElse(journeyConfigDefaults.CONFIRM_PAGE_TITLE)
  val heading: String = p.heading.getOrElse(journeyConfigDefaults.CONFIRM_PAGE_HEADING)
  val showSubHeadingAndInfo: Boolean = p.showSubHeadingAndInfo.getOrElse(false)
  val infoSubheading: String = p.infoSubheading.getOrElse(journeyConfigDefaults.CONFIRM_PAGE_INFO_SUBHEADING)
  val infoMessage: String = p.infoMessage.getOrElse(journeyConfigDefaults.CONFIRM_PAGE_INFO_MESSAGE_HTML)
  val submitLabel: String = p.submitLabel.getOrElse(journeyConfigDefaults.CONFIRM_PAGE_SUBMIT_LABEL)
...
case class ResolvedLookupPage(p: LookupPage, journeyConfigDefaults: JourneyConfigDefaults) {
  val title: String = p.title.getOrElse(journeyConfigDefaults.LOOKUP_PAGE_TITLE)
  val heading: String = p.heading.getOrElse(journeyConfigDefaults.LOOKUP_PAGE_HEADING)
  val filterLabel: String = p.filterLabel.getOrElse(journeyConfigDefaults.LOOKUP_PAGE_FILTER_LABEL)
  val postcodeLabel: String = p.postcodeLabel.getOrElse(journeyConfigDefaults.LOOKUP_PAGE_POSTCODE_LABEL)
  val submitLabel: String = p.submitLabel.getOrElse(journeyConfigDefaults.LOOKUP_PAGE_SUBMIT_LABEL)
  // TODO
  val resultLimitExceededMessage: Option[String] = None
  val noResultsFoundMessage: Option[String] = None
  val manualAddressLinkText: String = p.manualAddressLinkText.getOrElse(journeyConfigDefaults.LOOKUP_PAGE_MANUAL_ADDRESS_LINK_TEXT)
}
...
case class ResolvedSelectPage(p: SelectPage, journeyConfigDefaults: JourneyConfigDefaults) {
  ...
  val heading: String = p.heading.getOrElse(journeyConfigDefaults.SELECT_PAGE_HEADING)
  val headingWithPostcode: String = p.headingWithPostcode.getOrElse(journeyConfigDefaults.SELECT_PAGE_HEADING_WITH_POSTCODE)
  val proposalListLabel: String = p.proposalListLabel.getOrElse(journeyConfigDefaults.SELECT_PAGE_PROPOSAL_LIST_LABEL)
...
case class ResolvedEditPage(p: EditPage, journeyConfigDefaults: JourneyConfigDefaults) {
  val title: String = p.title.getOrElse(journeyConfigDefaults.EDIT_PAGE_TITLE)
  val heading: String = p.heading.getOrElse(journeyConfigDefaults.EDIT_PAGE_HEADING)
  val line1Label: String = p.line1Label.getOrElse(journeyConfigDefaults.EDIT_PAGE_LINE1_LABEL)
  val line2Label: String = p.line2Label.getOrElse(journeyConfigDefaults.EDIT_PAGE_LINE2_LABEL)
  val line3Label: String = p.line3Label.getOrElse(journeyConfigDefaults.EDIT_PAGE_LINE3_LABEL)
  val townLabel: String = p.townLabel.getOrElse(journeyConfigDefaults.EDIT_PAGE_TOWN_LABEL)
  val postcodeLabel: String = p.postcodeLabel.getOrElse(journeyConfigDefaults.EDIT_PAGE_POSTCODE_LABEL)
  val countryLabel: String = p.countryLabel.getOrElse(journeyConfigDefaults.EDIT_PAGE_COUNTRY_LABEL)
  val submitLabel: String = p.submitLabel.getOrElse(journeyConfigDefaults.EDIT_PAGE_SUBMIT_LABEL)
}
