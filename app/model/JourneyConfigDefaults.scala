...
object JourneyConfigDefaults {
  ...
  object WelshConstants extends JourneyConfigDefaults {
    ...
    val CONFIRM_PAGE_SUBMIT_LABEL = "Cadarnhau ac yn eich blaen"
    val CONFIRM_PAGE_EDIT_LINK_TEXT = "Golygu’r cyfeiriad hwn"
    ...
    val EDIT_PAGE_LINE2_LABEL = "Llinell cyfeiriad 2"
    val EDIT_PAGE_LINE3_LABEL = "Llinell cyfeiriad 3"
    ...
    val SELECT_PAGE_TITLE = "Dewiswch y cyfeiriad"
    val SELECT_PAGE_HEADING = "Dewiswch y cyfeiriad"
